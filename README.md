...
[![Go Report Card](https://goreportcard.com/badge/github.com/edison4354/makesite)](https://goreportcard.com/report/github.com/edison4354/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the Aurora library. The documentation is located at https://pkg.go.dev/github.com/logrusorgru/aurora/v3. My goal is to use it to implement ANSI-colors to the terminal output for better readability.`
- [x] **Add, commit, and push to GitHub**.
